...
if __name__ == "__main__":
    ...
    if method == 'PIELM':
        visual.plot_solutions_2D(X, T, save_path="png_save/PIELM",filename="PIELM_Heat1D.png")
    
    elif method == 'RINN':
        visual.plot_solutions_2D(X, T, save_path="png_save/RINN",filename="RINN_Heat1D.png")

    elif method == 'RINN_es':
        visual.plot_solutions_2D(X, T, save_path="png_save/RINN_es",filename="RINN_es_Heat1D.png")
    else:
