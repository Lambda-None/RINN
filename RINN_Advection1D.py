...
if __name__ == "__main__":
    ...
    domain = torch.tensor((-1, 1, 0, 1), dtype=type)
    ...
    if method == 'PIELM':
        visual.plot_solutions_2D(xx, tt, save_path="png_save/PIELM",filename="PIELM_Advection1D.png")
    
    elif method == 'RINN':
        visual.plot_solutions_2D(xx, tt, save_path="png_save/RINN",filename="RINN_Advection1D.png")

    elif method == 'RINN_es':
        visual.plot_solutions_2D(xx, tt, save_path="png_save/RINN_es",filename="RINN_es_Advection1D.png")
    else:
