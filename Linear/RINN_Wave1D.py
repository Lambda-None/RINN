...
if __name__ == "__main__":
    ...
    domain = torch.tensor((0, 1, 0, 1), dtype=dtype)
    ...
    if method == 'PIELM':
        visual.plot_solutions_2D(xx, tt, save_path="Save_Fig/linear_evolution",filename="PIELM_Wave1D.pdf")
    
    elif method == 'RINN':
        visual.plot_solutions_2D(xx, tt, save_path="Save_Fig/linear_evolution",filename="RINN_Wave1D.pdf")

    elif method == 'RINN_es':
        visual.plot_solutions_2D(xx, tt, save_path="Save_Fig/linear_evolution",filename="RINN_es_Wave1D.pdf")
    else:
