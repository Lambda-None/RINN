...
if __name__ == "__main__":
    ...
    if method == 'PIELM':
        visual.plot_solutions_2D(X_plot, Y_plot, save_path="Save_Fig/linear_steady",filename="PIELM_Possion2D.pdf")
    
    elif method == 'RINN':
        visual.plot_solutions_2D(X_plot, Y_plot, save_path="Save_Fig/linear_steady",filename="RINN_Possion2D.pdf")

    elif method == 'RINN_es':
        visual.plot_solutions_2D(X_plot, Y_plot, save_path="Save_Fig/linear_steady",filename="RINN_es_Possion2D.pdf")
    else:
